    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-slate-950 text-white px-6">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-slate-400 text-lg mb-6 leading-relaxed">
          The website is currently undergoing a technical system update.
          Access has been temporarily restricted while we resolve the issue.
        </p>

        <p className="text-slate-500 text-sm mb-10 leading-relaxed">
          Our technical team is working on the system. Please try again
          shortly once the update has been completed.
        </p>
